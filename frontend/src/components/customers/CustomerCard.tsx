...
export function CustomerCard({
    ...
    return (
        <>
            <Card
                className={`hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5 ${
            ...
            >
                ...
                <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t">
                        ...
                        <Button
                            size="sm"
                            className="bg-green-500 hover:bg-green-600 text-white transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
                            asChild
                        >
                            <a
